...
3. `authControllerProvider` - 10 edges
4. `categories` - 9 edges
5. `AppDatabase` - 9 edges
6. `coyoteProvider` - 8 edges
7. `_AppShellState` - 8 edges
8. `userSessionServiceProvider` - 7 edges
9. `_JnatrjoAppState` - 7 edges
10. `ApiClient` - 6 edges

## Surprising Connections (you probably didn't know these)
- `dio ^5.10.0` --references--> `ApiClient`  [INFERRED]
  pubspec.yaml → lib/core/api/api_client.dart
- `drift ^2.34.1 + drift_dev (único codegen)` --references--> `AppDatabase`  [INFERRED]
  pubspec.yaml → lib/core/storage/app_database.dart
...
Cohesion: 0.02
Nodes (94): _, actualTableName, _alias, aliasedName, allSchemaEntities, allTables, attachedDatabase, _completedAtMeta (+86 more)
...
Cohesion: 0.05
Nodes (39): _abortDraft, audioUrl, _buildCard, _cardAt, _cards, _cardWidthPct, createState, dispose (+31 more)

### Community 5 - "Mascota coyote y burbujas"
Cohesion: 0.05
Nodes (35): coyote_controller.dart, CustomPainter, _BubblesPainter, _Bubble, _BubbleTailPainter, child, _CoyoteImage, CoyoteOverlay (+27 more)
...
Cohesion: 0.06
Nodes (35): double x, y, w,, _activeTopic, build, _buildGamesList, contains, createState, db, enterMapChrome (+27 more)

### Community 9 - "Pantalla de login y registro"
Cohesion: 0.05
Nodes (39): ../auth_controller.dart, ../google_sign_in_helper.dart, authServiceProvider, AuthScreen, _AuthScreenState, build, _buildError, _buildGoogleButton (+31 more)
...
Cohesion: 0.06
Nodes (35): MediaItem, mediaServiceProvider, build, _buildPlayer, _controller, createState, _cueKey, dispose (+27 more)
...
Cohesion: 0.07
Nodes (27): BoxFit, double?, audioPath, _audioPlayer, _broken, build, cardState, color (+19 more)

### Community 15 - "Vista Quiz"
Cohesion: 0.07
Nodes (27): GameConfig get, build, _buildOption, _combo, _config1, _config2, _correctOption, createState (+19 more)
...
Cohesion: 0.07
Nodes (27): Answer? get, class, build, _buildFillBlankPrompt, _buildOption, _config1, _config2, _correctOption (+19 more)

### Community 18 - "Vista Memorama"
Cohesion: 0.07
Nodes (26): audioUrl, back, _cards, createState, dispose, _elapsed, _finished, _flipped (+18 more)

### Community 19 - "Asignaciones y en construcción"
Cohesion: 0.22
Nodes (9): ../../app/activity_config.dart, ../../app/theme.dart, ../../core/sync/sync_service.dart, build, GamesHubScreen, showModalBottomSheet, showSyncSummarySheet, package:go_router/go_router.dart (+1 more)

### Community 20 - "Repositorio del diccionario"
Cohesion: 0.05
Nodes (46): AsyncNotifier, Reescritura de URLs a rutas de disco al precargar assets, CachedGames — contenido jugable por gameId, Diccionario: emisión instantánea con refresh en segundo plano, dart:io, cache, dio, dir (+38 more)

### Community 21 - "Servicio de sincronización"
Cohesion: 0.09
Nodes (25): ../connectivity/connectivity_service.dart, int get, activities, correctAnswers, _db, dismissSummary, gameType, levelAfter (+17 more)
...
Cohesion: 0.10
Nodes (20): ../../about/about_view.dart, AnimationController, _AboutPage, build, _buildAboutTeaser, _buildGamesShowcase, _buildPhrases, color (+12 more)
...
Cohesion: 0.10
Nodes (28): ConsumerState, ConsumerStatefulWidget, AssignmentsScreen, _AssignmentsScreenState, VerifyEmailScreen, _VerifyEmailScreenState, _PendingTile, _PendingTileState (+20 more)

### Community 26 - "Dashboard"
Cohesion: 0.09
Nodes (21): dashboard_providers.dart, activities, activity, _CardTitle, color, createState, data, _game (+13 more)
...
Cohesion: 0.10
Nodes (19): ../features/about/about_view.dart, ../features/assignments/assignments_screen.dart, ../features/auth/screens/auth_screen.dart, ../features/auth/screens/verify_email_screen.dart, ../features/auth/screens/welcome_screen.dart, ../features/content/content_screen.dart, ../features/content/media_player_screen.dart, ../features/dashboard/dashboard_screen.dart (+11 more)

### Community 29 - "Tarjetas privadas de UI"
Cohesion: 0.10
Nodes (20): _AudioCover, _AudioDisc, _LeaderTile, _PendingActivitiesCard, _QuickActions, _StatsGrid, _ComboBadge, _FlipCard (+12 more)

### Community 30 - "Controlador de autenticación"
Cohesion: 0.14
Nodes (13): AuthService get, bool get, core/storage/session_store.dart, ../../../data/services/auth_service.dart, _auth, build, isAuthenticated, loginStudent (+5 more)
...
Cohesion: 0.13
Nodes (14): GameInfo get, games_providers.dart, GameInfo, GameSummaryDto, _ActivityCard, createState, disabled, game (+6 more)

### Community 33 - "Pantalla del diccionario"
Cohesion: 0.14
Nodes (13): dictionary_repository.dart, ../games/widgets/game_widgets.dart, Word, _buildCategoryGrid, _buildWordsGrid, _categoryInfo, _categoryLabel, createState (+5 more)
...
Cohesion: 0.11
Nodes (19): AppUser? get, FlutterSecureStorage, clear, isAuthenticated, load, save, SessionStore, sessionStoreProvider (+11 more)

### Community 36 - "Providers con fallback a caché"
Cohesion: 0.10
Nodes (19): ../auth/auth_controller.dart, ../../core/storage/app_database.dart, ../../data/models/models.dart, ../../data/services/activity_service.dart, build, cacheKey, db, fromJson (+11 more)

### Community 37 - "Router y arranque de la app"
Cohesion: 0.17
Nodes (11): app/router.dart, data/services/misc_services.dart, features/auth/auth_controller.dart, createState, dispose, load, main, sessionStore (+3 more)

### Community 38 - "Archivos de juegos y coyote"
Cohesion: 0.13
Nodes (14): ../coyote/coyote_messages.dart, ../game_session.dart, createState, gameTypeId, ../../shared/widgets/under_construction.dart, views/intruso_game_view.dart, views/laberinto_game_view.dart, views/loteria_game_view.dart (+6 more)

### Community 39 - "Pantalla de contenido"
Cohesion: 0.16
Nodes (13): ../../core/connectivity/connectivity_service.dart, build, color, _contentTabs, _formatDuration, icon, mediaByTypeProvider, _MediaList (+5 more)

### Community 40 - "Servicio de autenticación"
Cohesion: 0.13
Nodes (14): _api, AuthService, LoginResult, loginStudent, loginVisitor, loginWithGoogle, raw, registerVisitor (+6 more)

### Community 41 - "Shell de navegación"
Cohesion: 0.13
Nodes (14): ../../core/sync/game_cache_service.dart, ../coyote/coyote_companion.dart, ../coyote/coyote_controller.dart, _applyChromeForTab, _branchPaths, createState, dispose, _isMapTab (+6 more)
...
Cohesion: 0.12
Nodes (16): gameSessionProvider, _restart, build, build, build, MemoramaGameView, _MemoramaGameViewState, build (+8 more)

### Community 44 - "Servicio de actividades"
Cohesion: 0.15
Nodes (12): ../../../core/api/api_client.dart, _api, completeActivity, getActivitiesByType, getAllGames, getGamesByTopic, getStudentActivities, getStudentDashboard (+4 more)

### Community 45 - "Servicios de diccionario y media"
Cohesion: 0.15
Nodes (12): _api, DictionaryService, dictionaryServiceProvider, endSession, getAllWords, getCategories, getMediaByType, getMediaStream (+4 more)
...
Cohesion: 0.33
Nodes (9): connectivityStreamProvider, isOnlineProvider, gameCacheServiceProvider, build, syncControllerProvider, ContentScreen, _AppShellState, build (+1 more)

### Community 50 - "Estados vacío, error y offline"
Cohesion: 0.17
Nodes (11): build, emoji, EmptyState, ErrorState, LoadingState, message, OfflineBanner, onRetry (+3 more)

### Community 51 - "Despacho de juegos"
Cohesion: 0.33
Nodes (6): build, coyoteProvider, build, initState, _speakForTab, Route /juegos
...
Cohesion: 0.22
Nodes (9): ConsumerWidget, _CoyoteLayer, dashboardProvider, build, DashboardScreen, _LeaderboardCard, _play, Route /dashboard/acerca (+1 more)

### Community 55 - "Verificación de email"
Cohesion: 0.20
Nodes (9): build, _buildResult, createState, initState, _message, _Status, token, ../../shared/widgets/states.dart (+1 more)

### Community 56 - "Convenciones y contratos con el backend"
Cohesion: 0.25
Nodes (8): Lints por defecto de flutter_lints, sin reglas propias, Convención: todo el código en español, Paridad intencional con la plataforma web React, Ícono adaptativo Android (coyote sobre #A8E6CF), SyncService, Tipografías Poppins + PublicSans empaquetadas, Sistema de estilo 'kid' 3D heredado de la web, XP y niveles sincronizados con el backend web

### Community 57 - "Tarjetas de estadísticas"
Cohesion: 0.20
Nodes (9): Color, kid_card.dart, build, color, icon, label, StatCard, subText (+1 more)

### Community 58 - "Principios offline-first y estilo"
Cohesion: 0.40
Nodes (6): KvEntries — copias JSON de dashboards, Patrón red-primero-luego-caché en providers, Offline-first (punto central del proyecto), PendingResults — cola de partidas sin red, Tres cachés distintas en drift, Contenido multimedia solo online
...
Cohesion: 0.25
Nodes (7): asset_preloader.dart, cacheAllGames, _db, _running, _service, ActivityService, ../storage/app_database.dart

### Community 61 - "Deuda de release y login"
Cohesion: 0.29
Nodes (7): Release firmado con keystore de debug, Google Sign-In usa el client ID web como serverClientId, sessionStoreProvider sobreescrito en main(), routerProvider, build, Verificación de email abre el navegador, Dos modos de login: estudiante y visitante
...
Cohesion: 0.20
Nodes (12): userSessionServiceProvider, authControllerProvider, _commit, logout, _showGoogleRegisterDialog, _submitLogin, _confirmLogout, didChangeAppLifecycleState (+4 more)

### Community 65 - "Base de datos drift"
Cohesion: 0.50
Nodes (5): _, @DriftDatabase, schemaVersion 1 sin MigrationStrategy, AppDatabase, drift ^2.34.1 + drift_dev (único codegen)

### Community 66 - "Identidad de actividad y sesión"
Cohesion: 0.50
Nodes (4): appDatabaseProvider, activityServiceProvider, GameSession, GameSessionController
...
Cohesion: 0.18
Nodes (10): ../dashboard/dashboard_providers.dart, ../games/game_session.dart, activity, _AssignmentCard, createState, disabled, onPlay, _page (+2 more)

### Community 69 - "Configuración del backend"
Cohesion: 0.50
Nodes (4): Backend por defecto en DigitalOcean, ApiClient, dio ^5.10.0, Backend por defecto en Koyeb (README)

### Community 70 - "Definición de tablas drift"
Cohesion: 0.50
Nodes (4): CachedGames, KvEntries, PendingResults, Table

### Community 71 - "Pantalla del reproductor"
Cohesion: 0.33
Nodes (6): activityId vs gameId (effectiveActivityId), Tolerancia a alias de campos del backend, gameConfigs[0]=prompt, gameConfigs[1]=opciones, ResponseLog.toJson() vs toApiJson(), Protocolo de sincronización de 2 pasos, Catálogo de 10 juegos

### Community 72 - "Pantalla de asignaciones"
Cohesion: 0.33
Nodes (5): build, title, UnderConstructionScreen, package:flutter/material.dart, package:flutter_svg/flutter_svg.dart

### Community 74 - "Capas de widgets Consumer"
Cohesion: 0.50
...
### Community 75 - "Ruta /welcome"
Cohesion: 0.50
Nodes (4): _buildFinalCta, _buildHero, Route /auth?mode=login, Route /auth?mode=register

### Community 80 - "AppShell"
Cohesion: 0.67
Nodes (3): Excepción de orientación horizontal para el mapa, AppShell, Mapa de aventuras por zonas
...
## Knowledge Gaps
- **1020 isolated node(s):** `generatedAt`, `ANIMALS`, `PRONOUNS`, `CLOTHES`, `FOOD` (+1015 more)
...
- **Why does `ApiClient` connect `Configuración del backend` to `Servicio de autenticación`, `Cliente HTTP y errores`, `Servicio de actividades`, `Servicios de diccionario y media`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `sessionStoreProvider sobreescrito en main()` connect `Deuda de release y login` to `Sesión en secure storage`?**
...
- **Should `Resumen de partida` be split into smaller, more focused modules?**
